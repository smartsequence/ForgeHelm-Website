...
// 產品相關 URL
export const APP_URL = 'https://app.docengine.com';
export const API_URL = 'https://api.docengine.com';

// 聯絡資訊
export const CONTACT_EMAIL = 'contact@smartsequence.tech';
export const SUPPORT_EMAIL = 'support@docengine.com';
